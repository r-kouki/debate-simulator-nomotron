...
- **[DETAILED_PROJECT_EXPLICATION_CREWAI.md](../nlp-project/DETAILED_PROJECT_EXPLICATION_CREWAI.md)** - Complete CrewAI System Deep-Dive
- **[DETAILED_PROJECT_EXPLICATION_BACKEND.md](../nlp-project/DETAILED_PROJECT_EXPLICATION_BACKEND.md)** - Python Backend Architecture
- **[DETAILED_PROJECT_EXPLICATION_FRONTEND.md](./DETAILED_PROJECT_EXPLICATION_FRONTEND.md)** - Frontend & API Documentation
- **[DETAILED_PROJECT_EXPLICATION_EXAMPLES.md](../nlp-project/DETAILED_PROJECT_EXPLICATION_EXAMPLES.md)** - Data Flow & Complete Examples
